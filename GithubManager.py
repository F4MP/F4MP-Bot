...
class GithubCommands(commands.Cog):
    ...
    @commands.command(brief='<Project Column Name>', description='This command is used for looking at F4MP Github project tasks. \n Note: May need to use quotations for multiword args (i.e "Multi Word Arg")')
    ...
    @commands.command(brief='<Project Column Name> <Project Card Contents>', description="Use this command to add cards to F4MP indev project.")
    @commands.has_role('Contributor')
